$repoDir = "C:\Users\ishan\Documents\Projects\Awesome-Knowledge-Graph-Platform"
...
"@
$content = $content -replace '(?s)## Open-Source GitHub Projects.*?### Additional Strong Open-Source Options', "$opensourceSection`r`n`r`n### Additional Strong Open-Source Options"
...
"@
$svgBanner | Set-Content -Path "assets/banner.svg" -Encoding UTF8
$content = "![Banner](assets/banner.svg)`r`n" + $content
$content | Set-Content -Path $readmePath -Encoding UTF8
git add .
...
$content = $content -replace "## ☁️ SaaS/Hosted Platforms", "## ☁️ SaaS/Hosted Platforms" 
...
# 4. SEO optimised
$content = "<!-- Keywords: Knowledge Graph, Graph Database, Semantic Web, Ontology, GraphRAG, Neo4j, RDF, SPARQL, SaaS, Open Source -->`r`n" + $content
...
$content = $content -replace "# Awesome Knowledge Graph Platform - The Ultimate Graph Database Guide", ($badgesLeft + "# Awesome Knowledge Graph Platform - The Ultimate Graph Database Guide")
$content | Set-Content -Path $readmePath -Encoding UTF8
git add .
...
$badgeRight = ' <a href="https://github.com/ishandutta2007"><img alt="GitHub followers" src="https://img.shields.io/github/followers/ishandutta2007?label=Follow" /></a>'
$content = $content -replace "Awesome Knowledge Graph Platform - The Ultimate Graph Database Guide", ("Awesome Knowledge Graph Platform - The Ultimate Graph Database Guide" + $badgeRight)
$content | Set-Content -Path $readmePath -Encoding UTF8
git add .
